...
@Component({
  selector: 'app-user-deposit-reports',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './user-deposit-reports.component.html',
  styleUrl: './user-deposit-reports.component.scss'
})
export class UserDepositReportsComponent {
    ...
    ngOnInit(): void {
      ...
      this.route.queryParams.subscribe((param: any) => {
        if (param.id) {
         ...
         this.shared.setSidebrActiveClass('user-deposit-reports')
          this.profileId = ''
        this.page= 1
          this.shared.setReportTab(this.profileId)
