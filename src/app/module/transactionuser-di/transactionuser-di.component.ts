...
@Component({
  selector: 'app-transactionuser-di',
  standalone: true,
 imports: [NgbTooltipModule, NgbDropdownModule, CommonModule, FormsModule, CommonmoduleModule],
  templateUrl: './transactionuser-di.component.html',
  styleUrl: './transactionuser-di.component.scss'
})
export class TransactionuserDiComponent {
    ...
    ngOnInit(): void {
      ...
      this.shared.setSidebrActiveClass('user-distributor');
