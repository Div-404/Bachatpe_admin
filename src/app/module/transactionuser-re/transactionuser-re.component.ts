...
@Component({
  selector: 'app-transactionuser-re',
  standalone: true,
  imports: [NgbTooltipModule, NgbDropdownModule, CommonModule, FormsModule, CommonmoduleModule],
  templateUrl: './transactionuser-re.component.html',
  styleUrl: './transactionuser-re.component.scss'
})
export class TransactionuserReComponent {
  SelectedTab: any = ""
  tiemStampList: any = []
  ...
  ngOnInit(): void {
    ...
    this.shared.setSidebrActiveClass('user-main/user-retailer');
  ...
  getUserRiRange() {
    ...
    this.api.getReportsRiTime(data).subscribe({
      next: (res: any) => {
        this.shared.loader(false)
        this.tiemStampList = res.lstTrans
        this.overTimeList = res.lstTrans
